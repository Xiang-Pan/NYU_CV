...
LastEditTime: 2021-09-30 17:40:56
...
class TfmNetHighway(nn.Module):
    def __init__(self, num_classes=43):
        super(TfmNetHighway, self).__init__()
...
class TfmNet1(nn.Module):
    def __init__(self, num_classes=43):
        super(TfmNet1, self).__init__()
        
        # CNN layers
        self.conv1 = nn.Conv2d(3, 100, kernel_size=5)
        self.activation1 = nn.LeakyReLU(2)
        self.bn1 = nn.BatchNorm2d(100)
        
        self.conv2 = nn.Conv2d(100, 150, kernel_size=3)
        self.activation2 = nn.LeakyReLU(2)
        self.pool2 = nn.MaxPool2d()
        self.bn2 = nn.BatchNorm2d(150)
        self.drop2 = nn.Dropout2d()
        
        self.conv3 = nn.Conv2d(150, 250, kernel_size=3)
        self.activation3 = nn.LeakyReLU(2)
